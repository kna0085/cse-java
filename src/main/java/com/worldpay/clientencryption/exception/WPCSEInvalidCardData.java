...
public class WPCSEInvalidCardData extends WPCSEException {
     ...
     *
     * @see com.worldpay.clientencryption.WPCardValidator
     */
     ...
     * would be provided back to the caller app. All these codes are mapped to {@link com.worldpay.clientencryption.WPValidationErrorCodes}
     <ul>
     ...
     *  @see com.worldpay.clientencryption.WPValidationErrorCodes
     *
